...
$objPHPExcel = PHPExcel_IOFactory::load("ficheros/MatrizInactividad_tim.xls");
...
$objWriter->save('ficheros/MatrizInactividad_tim.xls');
/*
//echo "fichero generado, enviamos mail?";
$textomail = "En adjunto se envia la matriz de inactividad de la promo BRA2 de la operadora Tim con los datos del dia anterior. \n ";
...
//envia_mail("Matriz Inactividad BRA2 Tim $fecha", $to,$cc, $textomail);
//echo "mail enviada";
