...
$query  = "exec proc_matriz_inactividad_operadora 1, 1";
$rs=mssql_query($query,$link);
$rs1=mssql_query($query,$link);
//echo mssql_get_last_message() . "\n";
//$objPHPExcel = new PHPExcel();
$objPHPExcel = PHPExcel_IOFactory::load("ficheros/MatrizInactividad_claro.xls");
...
$objWriter->save('ficheros/MatrizInactividad_claro.xls');
/*
//echo "fichero generado, enviamos mail?";
$textomail = "En adjunto se envia la matriz de inactividad de la promo BRA2 de la operadora claro con los datos del dia anterior. \n ";
...
//envia_mail("Matriz Inactividad BRA2 claro $fecha", $to,$cc, $textomail);
//echo "mail enviada";
